...
{
    const std::pair<std::pair<int, int>, Util::Rectangle> result = TileCache::parseInvalidateMsg(tiles);
...
std::pair<std::pair<int, int>, Util::Rectangle> TileCache::parseInvalidateMsg(const std::string& tiles)
{
    ...
    {
        return std::pair<std::pair<int, int>, Util::Rectangle>(
